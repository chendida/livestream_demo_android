...
public abstract class LiveBaseActivity extends BaseActivity {
    ...
    @BindView(R.id.gift_image) ImageView giftView;
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ALog.e("liveRoom.getAudienceNum() = " +liveRoom.getAudienceNum());
    ...
    void showMemberList() {
        ...
        executeTask(new ThreadPoolManager.Task<Void>() {
            ...
            @Override public void onSuccess(Void aVoid) {
                ...
                ALog.e(chatroom.getName()+":"+anchorId);
                if (anchorId.equals(EMClient.getInstance().getCurrentUser())) {
                    size = chatroom.getMemberCount() - 1;
                }
                ALog.e("size = " + size);
    ...
    private void showGift1Derect(final EMMessage message) {
        ...
        runOnUiThread(new Runnable() {
            @Override public void run() {
                ...
                int giftId = 0;
                try {
                    usernick = message.getStringAttribute(I.User.NICK);
    ...
    private void showGift2Derect(final EMMessage message) {
        ...
        runOnUiThread(new Runnable() {
            @Override public void run() {
                ...
                leftGiftView2.setName(usernick);
